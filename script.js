/* ============================================================
   Muhammed Rafnas & Rifana — site script
   ============================================================ */
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ---------------- Countdown ---------------- */
  const weddingDate = new Date('2026-10-24T16:00:00+05:30').getTime();
  ...
  if (waFab) {
    waFab.addEventListener('click', () => {
      const text = encodeURIComponent('You are invited! Muhammed Rafnas & Rifana — Nikkah on Saturday, 24 October 2026 · Kuningad. ' + window.location.href);
